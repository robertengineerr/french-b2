...
const seedVocab = [
  // --- money / work ---
  { fr: 'gagner de l’argent', en: 'to earn money', tags: ['argent', 'travail'] },
  { fr: 'dépenser', en: 'to spend (money)', tags: ['argent'] },
  { fr: 'économiser', en: 'to save (money)', tags: ['argent'] },
  { fr: 'le loyer', en: 'the rent', tags: ['logement', 'argent'] },
  ...
  { fr: 'les jours fériés', en: 'public holidays', tags: ['travail'] },
  { fr: 'une pause', en: 'a break', tags: ['travail'] },
  ...
  // --- housing / city ---
  { fr: 'le bâtiment', en: 'building', tags: ['logement', 'ville'] },
  { fr: 'construire', en: 'to build', tags: ['logement', 'ville'] },
  {
    fr: 'peuplé / bondé',
  ...
  { fr: 'la chambre à coucher', en: 'bedroom', tags: ['logement'] },
  { fr: 'les murs (m. pl.)', en: 'walls', tags: ['logement'] },
  { fr: 'peindre', en: 'to paint', tags: ['logement'] },
  { fr: 'bleu foncé', en: 'dark blue', note: 'foncé = dark, clair = light. Invariable in pairs: des murs bleu foncé.', tags: ['logement'] },
  { fr: 'proche (de)', en: 'near, close (to)', tags: ['ville'] },
  { fr: 'les collines (f. pl.)', en: 'hills', tags: ['nature'] },
  { fr: 'les véhicules (m. pl.)', en: 'vehicles', tags: ['transport'] },
  { fr: 'rouler', en: 'to drive along, to roll', note: 'The vehicle’s motion: on roulait à 90. Conduire = to drive (the act).', tags: ['transport'] },
  { fr: 'emmener', en: 'to take (someone) somewhere', note: 'emmener une personne, emporter un objet.', tags: ['transport'] },
  { fr: 'le climatiseur / la clim', en: 'air conditioner / A/C', note: 'la clim is what people actually say.', tags: ['maison', 'climat'] },
  { fr: 'le ventilateur', en: 'fan', tags: ['maison', 'climat'] },
  ...
  // --- food ---
  { fr: 'la nourriture', en: 'food', tags: ['nourriture'] },
  { fr: 'la malbouffe', en: 'junk food', tags: ['nourriture', 'santé'] },
  { fr: 'bouffer', en: 'to eat (slang, = manger)', note: 'Familiar. Fine with friends, not in an interview.', tags: ['nourriture'] },
  { fr: 'du poulet frit', en: 'fried chicken', tags: ['nourriture'] },
  { fr: 'le plat', en: 'dish, course', tags: ['nourriture'] },
  { fr: 'la boisson', en: 'drink', tags: ['nourriture'] },
  { fr: 'goûter', en: 'to taste', tags: ['nourriture'] },
  { fr: 'à base de', en: 'made with, based on', tags: ['nourriture'] },
  { fr: 'la pâtisserie', en: 'pastry / pastry shop', tags: ['nourriture'] },
  { fr: 'la tasse', en: 'cup', tags: ['nourriture'] },
  { fr: 'vomir', en: 'to throw up', tags: ['santé'] },

  // --- people / feelings ---
  { fr: 'l’amitié (f.)', en: 'friendship', tags: ['relations'] },
  { fr: 'ensemble', en: 'together', tags: ['relations'] },
  { fr: 'seul(e)', en: 'alone — and, by feeling, lonely', note: 'For the feeling: je me sens seul. La solitude = loneliness.', tags: ['relations'] },
  { fr: 'solitaire', en: 'solitary; a loner', tags: ['relations'] },
  { fr: 'le courage', en: 'courage, nerve', note: 'From your note "su courage" — most likely son courage.', tags: ['relations'] },
  { fr: 'saluer', en: 'to greet, to say hello to', tags: ['relations'] },
  { fr: 'se moquer de', en: 'to make fun of', tags: ['relations'] },
  ...
  // --- daily life ---
  { fr: 'faire la grasse matinée', en: 'to sleep in', tags: ['quotidien'] },
  { fr: 'dormir', en: 'to sleep', tags: ['quotidien'] },
  { fr: 'sortir', en: 'to go out, to get out', tags: ['quotidien'] },
  { fr: 'dehors', en: 'outside', tags: ['quotidien'] },
  { fr: 'en hiver', en: 'in winter', note: 'en hiver / en été / en automne, but AU printemps.', tags: ['climat'] },
  { fr: 'à l’école', en: 'at school', tags: ['études'] },
  { fr: 'le livre sacré', en: 'the holy book, scripture', tags: ['culture'] },
  ...
  { fr: 'la chaîne', en: 'channel; chain', tags: ['média'] },
